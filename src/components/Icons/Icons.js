...
<svg 
    ...
    className={cx('svg-inline--fa fa-triangle-exclamation _errorIcon_1fn2z_30" role="img" ')}
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 512 512">
    <path 
        fill="currentColor" 
...
export const ShowPassword = ({ width = '2rem', height = '2rem', className }) => (
<svg 
    width={width}
    height={height}
    aria-hidden="true" 
    ...
    data-prefix="fas" 
    data-icon="eye" 
    className={cx('svg-inline--fa fa-eye')}
    role="img" 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 576 512">
    <path 
...
export const HidePassword = ({ width = '2rem', height = '2rem', className }) => (
<svg 
    width={width}
    height={height}
    aria-hidden="true" 
    ...
    data-prefix="fas" 
    data-icon="eye-slash" 
    className={cx('svg-inline--fa fa-eye-slash ')} 
...
export const Loading = ({ width = '2rem', height = '2rem', className }) => (
<svg 
    width={width}
    height={height}
    aria-hidden="true" 
